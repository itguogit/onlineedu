  ...
  //添加定时任务
    function editLink(edit){
        var index = layer.open({
            ...
            type : 2,
			area: ['540px', '550px'],
            content : path + "/quarz/edit.do?id="+edit.id
        })
        layui.layer.full(index);
        //改变窗口大小时，重置弹窗的宽高，防止超出可视区域（如F12调出debug的操作）
        $(window).on("resize",function(){
